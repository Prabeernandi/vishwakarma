...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .antMatchers("/validate/getValidationCounts", "/validate/getTotalRecordUserDetails").permitAll()
                .antMatchers("/validate/getSurveyPendingUserDetails", "/validate/getApprovalPendingUserDetails").permitAll()
                .antMatchers("/validate/getApprovalCompletedUserDetails").permitAll()
