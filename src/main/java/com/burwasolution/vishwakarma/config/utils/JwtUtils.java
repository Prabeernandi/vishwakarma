...
public class JwtUtils implements Serializable {
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + Constants.ACCESS_TOKEN_VALIDITY_SECONDS * 1000 * 100))
                .compact();
    }
    ...
    public String generateTokenUsername(String username) {
        ...
        return Jwts.builder()
                .setSubject(username)
                .claim(Constants.AUTHORITIES_KEY, username)
                .signWith(SignatureAlgorithm.HS256, Constants.SIGNING_KEY)
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + Constants.ACCESS_TOKEN_VALIDITY_SECONDS * 60 * 60))
                .compact();
    }
